...
import nbn.com.generic.restUtilities;
...
public class thomasBayerBankSteps {
    ...
    public void Make_the_request_to_thomasBayer_Bank_Service() {
        ...
        restUtilities.setBaseURI("http://www.thomas-bayer.com"); //Setup Base URI
        restUtilities.setBasePath("/axis2/services/BLZService/"); // Setup Base Path
        restUtilities.setSoapActionHeader("getBank"); //Setup Soap Action
        restUtilities.setContentType(ContentType.XML);
        res = restUtilities.getResponseAsPost(request1); //Get response
        xmlPath = restUtilities.getXMLPath(res); //Get XMLPath
